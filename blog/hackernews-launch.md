...
1. **TernaryPhysics: Neural networks running in eBPF for packet-level decisions**
2. **Show HN: We put AI in the Linux kernel (eBPF + ternary neural networks)**
3. **Show HN: Sub-microsecond ML inference in eBPF**
...
- Makes routing/filtering decisions at line rate
...
Happy to answer questions about eBPF constraints, ternary quantization, or anything else.
...
A: Depends on the task. For packet classification, ternary models get within 2-5% of float32 accuracy. The speed tradeoff is worth it when you're running inference millions of times per second.
